// highest_triple_feature.h

#ifndef HIGHEST_TRIPLE_FEATURE_H
#define HIGHEST_TRIPLE_FEATURE_H
...
class HighestTripleFeature : public FeatureExtractor {
public:
  Type type() const override { return Type::TurnLevel; }
  std::string name() const override { return "highest_triple"; }
...
#endif // HIGHEST_TRIPLE_FEATURE_H
