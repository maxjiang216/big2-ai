...
class RankLeFeature : public FeatureExtractor {
public:
  explicit RankLeFeature(int rank, const std::string &rank_name)
  ...
  std::string name() const override { return "n_le_" + rank_name_; }
